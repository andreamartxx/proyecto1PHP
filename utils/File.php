<?php
    ...
    class File {
        ...
        /**
         * Representas a un único campo file de un form
         *
         * @var string
         */
        private $file;
        ...
        /**
         * Nombre del fichero generado en documento root
         *
         * @var string
         */
        private $fileName;
         ...
         * @param integer $maxSize Tamaño máximo en bytes. Si es 0, tamaño es limitado
